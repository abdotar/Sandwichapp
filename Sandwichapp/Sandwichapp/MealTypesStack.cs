	...
	public class MealTypesStack : StackLayout 
	{
		...
		public MealTypesStack(int typeid/*type id from database  */)
		{
			...
			if(typeid == 1)
			{
				...
				labelicon.Source = ImageSource.FromResource("Sandwichapp.images.frylogo.png");
			}
			if (typeid == 2)
			{
				typelabel.Text = "СЕНДВИЧИ И РОЛЛЫ";
				labelicon.Source = ImageSource.FromResource("Sandwichapp.images.rollicon.png");
			}
			if (typeid == 3)
			{
				typelabel.Text = "БУРГЕРЫ";
				labelicon.Source = ImageSource.FromResource("Sandwichapp.images.burgericon.png");
			}
			if (typeid == 4)
			{
			...
			if (typeid == 5)
			{
				...
				labelicon.Source = ImageSource.FromResource("Sandwichapp.images.Shawerma.png");
			}
